    ...
    <>
      ...
      <main className="max-w-4xl mx-auto py-16 px-4">
        ...
        <section className="text-gray-700 leading-relaxed text-lg">
          ...
          <h2 className="text-2xl font-semibold mb-4">1. Responsable del Tratamiento de sus Datos Personales</h2>
          <p className="mb-4">
          ...
          <h2 className="text-2xl font-semibold mb-4">3. Finalidades del Tratamiento de Datos Personales</h2>
          <p className="mb-4">
          ...
          <h2 className="text-2xl font-semibold mb-4">4. Transferencia de Datos Personales</h2>
          <p className="mb-4">
