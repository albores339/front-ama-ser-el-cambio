...
const HeroSection: React.FC = () => (
  <header className="relative w-full h-screen bg-gradient-to-b from-cyan-500 to-blue-800 text-white flex flex-col justify-center items-center">
    ...
    <div className="relative z-10 text-center px-6">
      ...
      <Link href="/donar">
        <button className="animate-shake inline-block mt-6 bg-white text-cyan-800 font-bold py-4 px-10 rounded-full shadow-2xl transition-transform transform hover:scale-110 duration-300 ease-in-out hover:bg-lime-700 hover:text-white">
          Donar Ahora
        </button>
      </Link>
    </div>
