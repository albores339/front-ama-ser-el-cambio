...
const HeroSection: React.FC = () => {
  ...
  return (
    <header className="relative w-full h-full bg-gradient-to-b from-cyan-500 to-blue-800 text-white flex flex-col justify-center items-center rounded-lg">
      ...
      {/* Contenido del héroe */}
      <div className="relative z-1 text-center md:my-14 py-16 md:py-10 md:shadow-2xl lg:px-32 rounded-xl bg-black/30 backdrop-blur-3xl border boder-2 border-lime-700 p-2" data-aos="fade-up">
