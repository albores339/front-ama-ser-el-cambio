...
const AfiliadoCounter: React.FC = () => {
  ...
  return (
    <div
      id="afiliado-counter"
      className="flex flex-row justify-center items-center p-4 mx-auto text-xl md:text-4xl font-semibold mb-10 md:mb-20 lg:gap-10 gap-8 md:gap-2"
    >
      <div className='flex flex-col md:flex-row items-center lg:gap-6 justify-around'>
        <UserPlusIcon className='text-cyan-700 h-16 w-16 md:h-24 md:w-24 mx-2'/>
        <div className='flex flex-col text-center text-cyan-700'>
          {/* Ajusta el tamaño del número fijo para hacerlo más pequeño */}
          <p className='text-2xl md:text-6xl'>8</p> 
          <p>Años</p>
        </div>
      </div>
      <div className='flex flex-col md:flex-row items-center justify-around lg:gap-6'>
      ...
      <div className='flex flex-col md:flex-row items-center lg:gap-6 justify-around'>
        <CalendarIcon className='text-cyan-700 h-16 w-16 md:h-24 md:w-24 mx-2'/>
        <div className='flex flex-col text-center text-cyan-700'>
          {/* Ajusta el tamaño del número fijo para hacerlo más pequeño */}
          <p className='text-2xl md:text-6xl'>288</p> 
          <p>Eventos</p>
        </div>
      </div>
    </div>
