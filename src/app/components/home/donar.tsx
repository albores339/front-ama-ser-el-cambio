...
const DonateSection: React.FC = () => (
  <section id="donate" className="py-20 px-6 bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-500 text-white text-center rounded-lg shadow-lg animate-gradient-x bg-[length:200%_200%] mb-14">
