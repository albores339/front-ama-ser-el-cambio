...
const DonationDetails: React.FC = () => (
  <section id="detalles" className="text-base md:text-lg leading-relaxed text-gray-700 my-8 text-center max-w-screen-xl mx-auto">
    ...
    <h2 className="text-2xl md:text-4xl font-bold text-cyan-700 mb-4">Detalles de Donación</h2>

    {/* Información Legal */}
    <div className="my-12 max-w-3xl mx-auto bg-gray-100 p-6 rounded-lg shadow-md">
      <h2 className="text-xl md:text-3xl font-bold mb-4">Información Legal</h2>
      <div className="flex flex-col md:flex-row justify-between items-center space-x-6 text-base md:text-lg">
    ...
    <div className="bg-white shadow-lg rounded-lg p-8 mb-10">
      <h3 className="text-xl md:text-3xl font-bold text-gray-800 mb-4">Transferencia Bancaria</h3>
      ...
      <div className="flex flex-col items-center mb-4">
        ...
        <p className="text-base md:text-lg"><strong>Banco:</strong> Inbursa</p>
        <p className="text-base md:text-lg"><strong>Cuenta:</strong> 50042343396</p>
        <p className="text-base md:text-lg"><strong>CLABE:</strong> 036100500423433961</p>
      </div>
    </div>
  </section>
);
