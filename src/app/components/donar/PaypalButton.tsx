  ...
  return (
    <div className="text-center"> {/* Contenedor centrado */}
      <form action="https://www.paypal.com/donate" method="post" target="_top">
        ...
        <button
          type="submit"
          className="animate-shake bg-lime-700 text-white font-bold py-2 px-12 my-8 rounded-2xl hover:bg-lime-700 transition-all flex items-center justify-center mx-auto"
